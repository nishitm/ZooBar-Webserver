...
class ProfileAPIServer(rpclib.RpcServer):
    def __init__(self, user, visitor):
        ...
        os.setresuid(61040,61040,61040)
    ...
    def rpc_xfer(self, target, zoobars):
        bank_client.transfer(self.user, target, zoobars, auth_client.get_token(self.user))
...
class ProfileServer(rpclib.RpcServer):
    def rpc_run(self, pcode, user, visitor):
        ...
        # uname = ''.join(e for e in user if e.isalnum())
        userdir = "/tmp/" + base64.urlsafe_b64encode(user) 
